...
public class ShockWaveAbility extends Ability {
    ...
    public Color hitColor = JBColor.ancientLightMid;

    public Sound shootSound = JBSounds.shock;

    public Effect shootEffect = JBFx.circleOut;
    public Effect hitEffect = JBFx.hitSparkLarge;
