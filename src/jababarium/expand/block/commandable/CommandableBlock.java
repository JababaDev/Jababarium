...
public abstract class CommandableBlock extends Block {
    ...
    public static class CommandEntity implements Drawc, Timedc, Teamc {
        ...
        public String toString() {
            return "CommandEntity{" + "added=" + added + ", id=" + id + ", x=" + x + ", y=" + y + ", lifetime="
                    + lifetime + '}';
        }
    ...
    public abstract class CommandableBlockBuild extends Building implements Ranged {
        ...
        public Vec2 target() {
            ...
            if (tile != null) {
                ...
                return targetVec.set((Position) self());
        }
        ...
        public void add() {
            if (!added)
                JBGroups.commandableBuilds.add(this);
        ...
        public void remove() {
            if (added)
                JBGroups.commandableBuilds.remove(this);
